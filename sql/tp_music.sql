...
CREATE TABLE `collection`  (
  ...
  `song_album` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `collection` VALUES (1, 1, '稻香', '周杰伦', '魔杰座');
INSERT INTO `collection` VALUES (2, 1, '夕阳无限好', '陈奕迅', 'U87');
INSERT INTO `collection` VALUES (3, 1, '南瓜车', '薛凯琪', 'Fiona AVEP');
INSERT INTO `collection` VALUES (4, 1, '街灯晚餐', '卫兰', 'Imagine');
INSERT INTO `collection` VALUES (5, 1, '想去海边', '夏日入侵企画', '想去海边');
INSERT INTO `collection` VALUES (34, 7, '周杰伦-开不了口', '周杰伦', '范特西');
INSERT INTO `collection` VALUES (35, 7, 'G.E.M.邓紫棋-龙卷风', 'G.E.M.邓紫棋', '龙卷风');
INSERT INTO `collection` VALUES (36, 7, 'G.E.M.邓紫棋-泡沫', 'G.E.M.邓紫棋', 'Xposed');
INSERT INTO `collection` VALUES (37, 7, '陈奕迅-不要说话', '陈奕迅', '不想放手');
INSERT INTO `collection` VALUES (41, 7, '陈奕迅 + 王菲-因为爱情', '陈奕迅', 'Stranger Under My Skin');
...
INSERT INTO `consumer` VALUES (5, '789', '789', 0, '13634377258', '666@126.com', '2019-01-08 21:15:48', '今天很开心啊', '山西', '/img/avatorImages/1552354056660L1.jpg', '2019-01-07 16:16:42', '2019-01-08 21:15:48');
...
CREATE TABLE `user`  (
  ...
  `uinfo` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`uid`) USING BTREE,
  UNIQUE INDEX `uname`(`uname`, `uemail`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin2', 'Z6p4Y6p4X6p4', '123@qq.com', '男', '12345678901', NULL, '123');
INSERT INTO `user` VALUES (2, 'admin', 'Z6p4Y6p4X6p4', '111', '男', '1111', NULL, NULL);
INSERT INTO `user` VALUES (3, '11', 'Z6p4Y6p4X6p4', '11', NULL, NULL, NULL, NULL);
INSERT INTO `user` VALUES (4, '22', 'Z6p4Y6p4X6p4', '22', NULL, NULL, NULL, NULL);
INSERT INTO `user` VALUES (5, 'xiao', 'Z6p4Y6p4X6p4', '123', '女', '123123', NULL, '111111');
INSERT INTO `user` VALUES (6, '1234', 'Z6p4Y6p4X6p4', '123', NULL, NULL, NULL, NULL);
INSERT INTO `user` VALUES (7, '567', 'd6p4c6p4b6p4', '小王', '女', '11111111', NULL, '1111111');
INSERT INTO `user` VALUES (8, 'xiaowang', 'c6p4b6p4a6p4Z6p4Y6p4X6p4', '123@qq.com', '女', '13421590677', NULL, '111111');
